...
namespace Zentity.Rdf.Xml
{
    ...
    /// http://www.w3.org/TR/2004/REC-rdf-syntax-grammar-20040210/#parseTypeOtherPropertyElt production.
    /// </summary>
    internal sealed class ProductionParseTypeOtherPropertyElement : Production
    {
        ...
        #region Internal
        /// <summary>
        /// Initializes a new instance of the ProductionParseTypeOtherPropertyElement class. 
        ...
        internal ProductionParseTypeOtherPropertyElement(EventElement propertyElement)
        {
        ...
        #region Internal
        /// <summary>
        /// Validates property element based on following syntax rules, 
        /// <br/>
            ...
            foreach (EventAttribute attribute in innerElement.Attributes)
            {
                ...
                if (production != null)
                    ...
                    throw new RdfXmlParserException(
                        Constants.ErrorMessageIds.MsgParseTypeOtherPropertyElementNoOtherAttrs,
                        innerElement.LineInfo);
            }

            if (set.Where(tuple => tuple is ProductionIdAttribute).Count() > 1)
                throw new RdfXmlParserException(Constants.ErrorMessageIds.MsgParseTypeOtherPropertyElementMoreThanOneIdAttr, innerElement.LineInfo);
            if (set.Where(tuple => tuple is ProductionParseOther).Count() != 1)
                throw new RdfXmlParserException(Constants.ErrorMessageIds.MsgParseTypeOtherPropertyElementSingleParseOtherAttr, innerElement.LineInfo);
        ...
        private void GenerateTriples(Graph outputGraph)
        {
            ...
            //This production matches and acts as if production parseTypeLiteralPropertyElt 
            //was matched. No extra triples are generated for other rdf:parseType values. 
        ...
        private static Production GetProductionAttribute(EventAttribute attribute)
        {
            if (attribute.Uri == IDUri)
                ...
                return new ProductionParseOther(attribute);
