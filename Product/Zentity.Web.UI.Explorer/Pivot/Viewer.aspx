<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="Viewer.aspx.cs" Inherits="Zentity.Web.UI.Explorer.Pivot.Viewer" %>

<asp:Content ID="titleContent" ContentPlaceHolderID="titleContentPlaceHolder" runat="server">
    Welcome to Zentity Pivot Viewer
</asp:Content>
            ...
            <td>
                <div id="errorSummaryContainer" runat="server" visible="false" style="position: relative">
                    <span style="font-size: medium; font-weight: normal; font-style: normal; color: #FF0000">
                        ...
                        to the <a href="Gallery.aspx">Pivot Gallery</a> to view available collections.</span>
                </div>
            </td>
        </tr>
    </table>
    ...
    <div id="Footer">
        <ul>
           <li class="first">
            ...
            <li>
                <a title="OData Viewer" href="ODataViewer.aspx">OData Viewer</a>
            </li>
            <li>
