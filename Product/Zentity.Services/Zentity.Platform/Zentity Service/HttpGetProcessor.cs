...
namespace Zentity.Platform
{
    ...
    /// <summary>
    /// The class responsible for handling Http GET request.
    /// </summary>
    public abstract class HttpGetProcessor : HttpRequestProcessor
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpGetProcessor"/> class.
        /// </summary>
        protected HttpGetProcessor()
        {
        }
        ...
        internal HttpGetProcessor(string baseAddress)
            : base(baseAddress)
        {
        }

        /// <summary>
        /// Validates the specified GET request.
        /// </summary>
        ...
        /// <summary>
        /// Processes the GET request sent to the specified Uri. 
