...
{
    /// <summary>
    /// Represents OR operator between 2 expressions of the Zentity search tree.
    /// </summary>
    internal class OrOperator : CompoundOperator
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of <see cref="OrOperator"/>.
        /// </summary>
        public OrOperator()
            : base(NodeType.Or)
        { }
