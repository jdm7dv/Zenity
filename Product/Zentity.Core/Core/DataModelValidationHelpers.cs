...
namespace Zentity.Core
{
    public sealed partial class DataModel
    {
        ...
        private void Validate()
        {
            ...
            catch (ZentityException)
            {
                throw new ModelItemValidationException(
                    CoreResources.ExceptionCycleInDependencyGraph);
            }
            ...
            foreach (DataModelModule module in this.Modules)
            {
                ...
                {
                    throw new ModelItemValidationException(
                        CoreResources.InvalidResourceTypesCyclicInheritance);
                }
            }
            ...
            {
                throw new ModelItemValidationException(
                    CoreResources.ValidationExceptionSeeInnerException,
                    ex);
            }
        ...
        private void ValidateCSharpIdentifiers()
        {
            ...
            if (results.Errors.Count > 0)
            {
                ...
                throw new ModelItemValidationException(string.Format(
                    ...
                    CoreResources.ValidationExceptionInvalidCSharpIdentifier,
                    errorText.ToString()));
            }
        }
        ...
        private static void ValidateMsShippedModuleChanges(DataModel originalModel, DataModel newModel)
        {
            ...
            if (deletedModule != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedModuleDeleted,
            ...
            if (updatedModule.Key != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedModuleUpdated,
            ...
            if (addedResourceType != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedResourceTypeAdded,
            ...
            if (deletedResourceType != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedResourceTypeDeleted,
            ...
            if (updatedResourceType.Key != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedResourceTypeUpdated,
            ...
            if (addedScalarProperty != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedScalarPropertyAdded,
            ...
            if (deletedScalarProperty != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedScalarPropertyDeleted,
            ...
            if (updatedScalarProperty.Key != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedScalarPropertyUpdated,
            ...
            if (addedNavigationProperty != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedNavigationPropertyAdded,
            ...
            if (deletedNavigationProperty != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedNavigationPropertyDeleted,
            ...
            if (updatedNavigationProperty.Key != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedNavigationPropertyUpdated,
            ...
            if (addedAssociation != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedAssociationAdded,
            ...
            if (deletedAssociation != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedAssociationDeleted,
            ...
            if (updatedAssociation.Key != null)
                throw new ModelItemValidationException(string.Format(CultureInfo.InvariantCulture,
                    CoreResources.ValidationExceptionMsShippedAssociationUpdated,
        ...
        private void ValidateUniqueForwardPathsAndIds()
        {
            ...
            // path from the DataModel reference to its items. For example,
            ...
            DuplicateFinder d = delegate(object item, Guid id)
            {
                if (visited.Values.Contains(id))
                    throw new ModelItemValidationException(string.Format(
                        CultureInfo.InvariantCulture,
                        CoreResources.ValidationExceptionDuplicateId, id));
                        ...
                        if (navigationProperty.Association != null)
                        {
                            ...
                            if (visitedRecordsForAssociation.Count() > 0)
                            {
                                ...
                                if (visitedRecord.Key != association)
                                    throw new ModelItemValidationException(string.Format(
                                        CultureInfo.InvariantCulture,
                                        CoreResources.ValidationExceptionDuplicateId,
                                        association.Id));
                            }
                        }
                    }
        ...
        private void ValidateReversePathsAndAssociations()
        {
            ...
            // DataModel model1 = new ZentityContext().DataModel;
            // DataModel model2 = new ZentityContext().DataModel;
            ...
            foreach (DataModelModule module in this.Modules)
            {
                ...
                if (module.Parent != this)
                    throw new ModelItemValidationException(string.Format(
                        CultureInfo.InvariantCulture,
                        CoreResources.ValidationExceptionCannotTraceItem,
                        CoreResources.DataModelModule, module.Id,
                        CoreResources.Namespace,
                ...
                foreach (ResourceType resourceType in module.ResourceTypes)
                {
                    if (resourceType.Parent != module)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionCannotTraceItem,
                            CoreResources.ResourceType, resourceType.Id,
                            CoreResources.Name,
                            resourceType.Name == null ? string.Empty : resourceType.Name));

                    // BaseType cannot be null.
                    if (resourceType.BaseType == null &&
                        resourceType.FullName != CoreResources.ZentityCoreResource)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionNullBaseType,
                            resourceType.Id,
                            resourceType.Name == null ? string.Empty : resourceType.Name));
                    ...
                    if (resourceType.BaseType != null &&
                        ...
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionBaseTypeNotInModel,
                            resourceType.Id,
                            resourceType.Name == null ? string.Empty : resourceType.Name));
                    ...
                    foreach (ScalarProperty scalarProperty in resourceType.ScalarProperties)
                        if (scalarProperty.Parent != resourceType)
                            throw new ModelItemValidationException(string.Format(
                                CultureInfo.InvariantCulture,
                                CoreResources.ValidationExceptionCannotTraceItem,
                                CoreResources.ScalarProperty, scalarProperty.Id,
                                CoreResources.Name,
                        ...
                        resourceType.NavigationProperties)
                    {
                        if (navigationProperty.Parent != resourceType)
                            throw new ModelItemValidationException(string.Format(
                                CultureInfo.InvariantCulture,
                                CoreResources.ValidationExceptionCannotTraceItem,
                                CoreResources.NavigationProperty, navigationProperty.Id,
                                CoreResources.Name, navigationProperty.Name == null ?
                ...
                foreach (NavigationProperty navigationProperty in moduleNavigationProperties)
                {
                    ...
                    if (navigationProperty.Association == null)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionAssociationNotFound,
                    ...
                    if (association.SubjectNavigationProperty == null)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionNullNavigationProperty,
                            CoreResources.SubjectNavigationProperty, association.Id,
                    ...
                    if (association.ObjectNavigationProperty == null)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionNullNavigationProperty,
                            CoreResources.ObjectNavigationProperty, association.Id,
                            association.Name == null ? string.Empty : association.Name));
                    ...
                    if (navigationProperty.Direction == AssociationEndType.Undefined)
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionDirectionNotDefined,
                            navigationProperty.Id, navigationProperty.Name == null ?
                            string.Empty : navigationProperty.Name));
                    ...
                    if (navigationProperty.Direction == AssociationEndType.Subject &&
                        ...
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionDirectionOutOfSync,
                            navigationProperty.Id, navigationProperty.Name == null ?
                            string.Empty : navigationProperty.Name, CoreResources.Subject,
                            association.Id, association.Name == null ? string.Empty :
                            association.Name, CoreResources.SubjectNavigationProperty));
                    ...
                    if (navigationProperty.Direction == AssociationEndType.Object &&
                        ...
                        throw new ModelItemValidationException(string.Format(
                            ...
                            CoreResources.ValidationExceptionDirectionOutOfSync,
                            navigationProperty.Id, navigationProperty.Name == null ?
                            string.Empty : navigationProperty.Name, CoreResources.Object,
                            association.Id, association.Name == null ? string.Empty :
                            association.Name, CoreResources.ObjectNavigationProperty));
                    ...
                    if (!moduleNavigationProperties.Contains(otherEndProperty))
                        throw new ModelItemValidationException(string.Format(
                            CultureInfo.InvariantCulture,
                            CoreResources.ValidationExceptionOtherEndNotInModel,
                            association.Id, association.Name == null ? string.Empty :
