...
{
    /// <summary>
    /// This partial class has fuctionality to compare differences in two DataModels
    /// </summary>
    public sealed partial class DataModel
    {
        ...
        /// <param name="originalModules">The original modules.</param>
        /// <param name="targetModules">The target modules.</param>
        ...
        /// <summary>
        /// Compares the data model modules.
        /// </summary>
        /// <param name="changes">The data model changes.</param>
        /// <param name="originalModules">The original modules.</param>
        /// <param name="targetModules">The target modules.</param>
        ...
        /// <summary>
        /// Compares the navigation properties.
        /// </summary>
        /// <param name="changes">The data model changes.</param>
        /// <param name="originalModules">The original modules.</param>
        /// <param name="targetModules">The target modules.</param>
        ...
        /// <summary>
        /// Compares the scalar properties.
        /// </summary>
        /// <param name="changes">The data model changes.</param>
        /// <param name="originalModules">The original modules.</param>
        /// <param name="targetModules">The target modules.</param>
